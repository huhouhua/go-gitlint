[![Release](https://img.shields.io/github/release/huhouhua/go-gitlint.svg?style=flat-square)](https://github.com/huhouhua/go-gitlint/releases/latest)
[![Build Status](https://travis-ci.com/huhouhua/go-gitlint.svg?branch=master)](https://travis-ci.com/huhouhua/go-gitlint)
[![codecov](https://codecov.io/gh/huhouhua/go-gitlint/branch/master/graph/badge.svg)](https://codecov.io/gh/huhouhua/go-gitlint)
[![Go Report Card](https://goreportcard.com/badge/github.com/huhouhua/go-gitlint?style=flat-square)](https://goreportcard.com/report/github.com/huhouhua/go-gitlint)
[![codebeat badge](https://codebeat.co/badges/5d0a7cfd-3dfb-4cc9-bd4f-f310c02068eb)](https://codebeat.co/projects/github-com-huhouhua-go-gitlint-master)
[![Powered By: GoReleaser](https://img.shields.io/badge/powered%20by-goreleaser-green.svg)](https://github.com/goreleaser)
[![Go Doc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat-square)](http://godoc.org/github.com/huhouhua/go-gitlint)
[![PDD status](http://www.0pdd.com/svg?name=huhouhua/go-gitlint)](http://www.0pdd.com/p?name=huhouhua/go-gitlint)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://raw.githubusercontent.com/huhouhua/go-gitlint/master/LICENSE)
...
Use [`download-gitlint.sh`](https://raw.githubusercontent.com/huhouhua/go-gitlint/master/download-gitlint.sh):

1. `curl https://raw.githubusercontent.com/huhouhua/go-gitlint/master/download-gitlint.sh > download-gitlint.sh`
2. `chmod +x download-gitlint.sh`

Usage:
```
$ ./download-gitlint.sh -h
./download-gitlint.sh: download go binaries for huhouhua/go-gitlint

Usage: ./download-gitlint.sh [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/huhouhua/go-gitlint/releases
